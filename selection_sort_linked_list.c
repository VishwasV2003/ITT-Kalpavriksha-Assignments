...
Node* selection_sort(Node* head){
    ...
    while(temp_head_1!=NULL){
        temp_head_2=temp_head_1->next;
        Node* min_head=temp_head_1;
        while(temp_head_2!=NULL){
            if(temp_head_2->data<min_head->data){
                min_head=temp_head_2;
            }
            temp_head_2=temp_head_2->next;
        }
        int temp=temp_head_1->data;
        temp_head_1->data=min_head->data;
        min_head->data=temp;
